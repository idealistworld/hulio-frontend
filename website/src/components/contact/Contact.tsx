    ...
    return (
        <div className = "contact-container">
            <div id = "writing">
                ...
                <div className="infoButtons"><button id="action-button1" onClick = {() => window.open('mailto: team@hulio.app')}>Email Us</button> <button id="action-button2" onClick = {() => window.open('https://t.me/idealist')}>Text Us</button></div>
            </div>
        </div>
    )
}
