...
const LitepaperLeft = () =>{
    return (
        <div className="litepaper-container">
            <h1>Litepaper.</h1>
            <div style={{color: '#2c2b2b', borderRadius: '5px', padding: '3%', backgroundColor: 'white', height:'315px', width:'90%', border:'1px solid #4e4e4e', overflow:'auto'}} className= "scroll">
            ...
            <div style={{width: '80%'}}><button id="action-button2" className="fifth nav">Pitch Deck</button> <button id="action-button2" className="fifth nav">Pitch Video</button></div>
        </div>
    )
}

export default LitepaperLeft;